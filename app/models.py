...
class OteIntradayLimitUtilization(Base):
    ...
    delivery_date: Mapped[date] = mapped_column(Date, nullable=False)
    utilization_change_commodity_czk: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 4))
    utilization_change_imbalance_czk: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 4))
    utilization_change_total_czk: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 4))
    utilization_total_czk: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 2))
    limit_total_czk: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 2))
    limit_available_czk: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 2))
    created_at: Mapped[Optional[datetime]] = mapped_column(TIMESTAMP(timezone=True), server_default='CURRENT_TIMESTAMP')
    updated_at: Mapped[Optional[datetime]] = mapped_column(TIMESTAMP(timezone=True), server_default='CURRENT_TIMESTAMP')
